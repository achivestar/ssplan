            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class="d-grid gap-2 d-md-flex justify-content-md-end">
						<a href="/admin/bannerRegist" class="btn btn-primary mt-3 mb-3">롤링배너 등록</a>
					</div>
					 <table class="table ">
						...
						<nav aria-label="Page navigation example">
						  <ul class="pagination justify-content-center">
	                        ...
	                        <li class="page-item">
	                          <a class="page-link" href="/admin/banner?page=${pageMaker.startPage-1}#anch" aria-label="Previous">
                        	  ...
                        	  <a class="page-link" href="/admin/banner?page=${idx}#anch">${idx }</a></li>
                       		 </c:forEach>
                       		 
                       		    <c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
	                        <li class="page-item">
	                          <a class="page-link" href="/admin/banner?page=${pageMaker.endPage+1}#anch" aria-label="Next">
